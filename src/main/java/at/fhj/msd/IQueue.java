...
public interface IQueue<T> {
   ...
   *
   * @param obj Object which will be added into the queue
   * @return true when the object was successfully added to the queue
   */
  boolean offer(T obj);
   ...
   *
   * @return  head (first) element of the queue
   */
  T poll();
